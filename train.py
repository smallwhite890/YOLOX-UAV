...
if __name__ == "__main__":
    ...
    if True:
        ...
        train_dataloader = YoloDatasets(train_lines, input_shape, batch_size, num_classes, end_epoch - start_epoch,
                                        mosaic=mosaic, train=True)
        val_dataloader = YoloDatasets(val_lines, input_shape, batch_size, num_classes, end_epoch - start_epoch,
